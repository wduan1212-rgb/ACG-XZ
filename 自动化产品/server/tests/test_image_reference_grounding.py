...
class ImageReferenceGroundingTest(unittest.TestCase):
    ...
    def test_client_sequence_requires_real_reference_grounding_before_prompts(self):
        ...
        self.assertLess(image_pipeline.index("prepareBatchImageReferencePlan"), image_pipeline.index("planAndPersistBatchImageCards"))
        self.assertIn("imageReferencePlan,", image_pipeline)
