...
class FrontendModuleIdentityTest(unittest.TestCase):
    ...
    def test_stateful_view_modules_have_one_cache_identity(self):
        expected = {
            ...
            "deliveryView.js": "v=20260728-v120-shell-19",
            "supplierViews.js": "v=20260728-v120-shell-19",
    ...
    def test_modified_stylesheets_share_current_build_identity(self):
        ...
        expected_versions = {
            "base.css": "v=20260728-v120-shell-19",
            "components.css": "v=20260723-v117-8",
            "views.css": "v=20260728-v120-shell-19",
            "agent.css": "v=20260728-v120-shell-19",
            "ui-motion.css": "v=20260728-v120-shell-19",
            "custom-creation.css": "v=20260728-v120-shell-19",
