...
class FrontendModuleIdentityTest(unittest.TestCase):
    ...
    def test_stateful_view_modules_have_one_cache_identity(self):
        expected = {
            "studio.js": "v=20260728-v120-shell-12",
            "prodDrawer.js": "v=20260728-v120-shell-12",
            "deliveryView.js": "v=20260728-v120-shell-12",
            "draftsView.js": "v=20260728-v120-shell-12",
            "voiceLab.js": "v=20260728-v120-shell-12",
            "chainWorkshop.js": "v=20260728-v120-shell-12",
    ...
    def test_custom_publish_is_loaded_with_the_current_module_identity(self):
        ...
        self.assertIn('import("./customPublish.js?v=20260728-v120-shell-12")', source)

    def test_modified_stylesheets_share_current_build_identity(self):
        index = (APP_DIR / "index.html").read_text(encoding="utf-8")
        expected_versions = {
            "base.css": "v=20260728-v120-shell-12",
            "components.css": "v=20260723-v117-8",
            "views.css": "v=20260728-v120-shell-12",
            "agent.css": "v=20260728-v120-shell-12",
            "ui-motion.css": "v=20260727-v118-7",
            "custom-creation.css": "v=20260728-v120-shell-12",
