...
"""
    ...
    def test_creative_video_uses_one_sketch_storyboard_sheet_and_one_30_second_job(self):
        ...
        self.assertIn('const directVideoRefs = [...storyboardRefs]', productions)
...
"""
    ...
    def test_batch_refine_and_creator_member_visibility_regressions(self):
        ...
        self.assertIn('row.voiceOutputs', settings)
...
"""
    ...
    def test_account_profile_seed_only_bootstraps_an_empty_account_store(self):
        ...
        self.assertIn('const APP_BUILD_ID = "20260811-v1423-batch-video-editor-1"', main)
        self.assertIn('js/main.js?v=20260811-v1423-batch-video-editor-1', index)
