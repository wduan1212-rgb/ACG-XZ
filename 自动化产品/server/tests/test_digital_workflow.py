...
"""
    ...
    def test_account_profile_seed_only_bootstraps_an_empty_account_store(self):
        ...
        self.assertIn('const APP_BUILD_ID = "20260724-v117-21"', main)
        self.assertIn('js/main.js?v=20260724-v117-21', index)
