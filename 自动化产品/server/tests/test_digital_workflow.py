...
"""
    ...
    def test_v84_subtitle_editor_review_and_dashboard_contract(self):
        ...
        self.assertIn('data-overview-detail="published"', overview)
        self.assertIn('data-overview-detail="views"', overview)
        self.assertIn('账号累计播放量', overview)
        ...
        self.assertIn('acc.totalViewCountOverride', overview)
        ...
        self.assertIn("todayPlatformRows", overview)
        self.assertIn("todayPlatformSummary", overview)
        self.assertIn("todayXhs.tooltip", overview)
        self.assertIn("todayVideo.tooltip", overview)
        self.assertIn('data-overview-detail="todayPlatforms"', overview)
    ...
    def test_account_profile_seed_only_bootstraps_an_empty_account_store(self):
        ...
        self.assertIn('const APP_BUILD_ID = "20260727-v118-7"', main)
        self.assertIn('js/main.js?v=20260727-v118-7', index)
