...
"""
    ...
    def test_account_profile_seed_only_bootstraps_an_empty_account_store(self):
        ...
        self.assertIn('const APP_BUILD_ID = "20260812-v1426-supplier-avatar-copy-limit-1"', main)
        self.assertIn('js/main.js?v=20260812-v1426-supplier-avatar-copy-limit-1', index)
