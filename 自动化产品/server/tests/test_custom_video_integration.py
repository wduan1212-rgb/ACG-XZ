...
class CustomVideoIntegrationTest(unittest.TestCase):
    ...
    def test_embedded_workshop_hides_duplicate_header_and_guards_ime_enter(self):
        ...
        self.assertIn("styles.css?v=20260817-v1436-token-plan-knowledge-2", html)
        self.assertIn("app.js?v=20260817-v1436-token-plan-knowledge-2", html)
...
if (frame.currentSrc !== "/custom-video/?embed=1&workspace=1&canPublish=1&release=20260817-v1436-token-plan-knowledge-2&project=history-project-1") {{
