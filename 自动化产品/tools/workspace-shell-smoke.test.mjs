...
test("video workshop is white, has no duplicate history rail, and exposes published counts", () => {
  ...
  assert.match(videoWorkshopHtml, /20260817-v1436-token-plan-knowledge-1/);
...
test("all modified workspace-shell resources use the v141 cache marker", () => {
  ...
  assert.match(indexHtml, /styles\/base\.css\?v=20260817-v1436-token-plan-knowledge-1"/);
  assert.match(indexHtml, /styles\/components\.css\?v=20260817-v1436-token-plan-knowledge-1"/);
  assert.match(indexHtml, /styles\/views\.css\?v=20260817-v1436-token-plan-knowledge-1"/);
  assert.match(indexHtml, /styles\/agent\.css\?v=20260817-v1436-token-plan-knowledge-1"/);
  assert.match(indexHtml, /styles\/ui-motion\.css\?v=20260817-v1436-token-plan-knowledge-1"/);
  assert.match(indexHtml, /styles\/custom-creation\.css\?v=20260817-v1436-token-plan-knowledge-1"/);
  assert.match(indexHtml, /js\/main\.js\?v=20260817-v1436-token-plan-knowledge-1"/);
  assert.match(mainJs, /from\s+"\.\/views\/overview\.js\?v=20260817-v1436-token-plan-knowledge-1"/);
  assert.match(mainJs, /from\s+"\.\/views\/assetsView\.js\?v=20260817-v1436-token-plan-knowledge-1"/);
  assert.match(mainJs, /from\s+"\.\/views\/deliveryView\.js\?v=20260817-v1436-token-plan-knowledge-1"/);
  assert.match(mainJs, /from\s+"\.\/views\/customCreation\.js\?v=20260817-v1436-token-plan-knowledge-1"/);
  assert.match(mainJs, /ui\/components\.js\?v=20260817-v1436-token-plan-knowledge-1/);
  assert.match(mainJs, /from\s+"\.\/agent\/view\.js\?v=20260817-v1436-token-plan-knowledge-1"/);
  assert.match(mainJs, /from\s+"\.\/ui\/icons\.js"/);
  assert.doesNotMatch(mainJs, /ui\/icons\.js\?v=/);
  assert.match(mainJs, /from\s+"\.\/domain\/delivery\.js\?v=20260817-v1436-token-plan-knowledge-1"/);
  assert.match(mainJs, /from\s+"\.\/core\/remote\.js"/);
  assert.doesNotMatch(mainJs, /core\/remote\.js\?v=/);
  assert.match(mainJs, /ui\/loginBeams\.js\?v=20260817-v1436-token-plan-knowledge-1/);
  assert.match(mainJs, /const APP_BUILD_ID\s*=\s*"20260817-v1436-token-plan-knowledge-1"/);
  assert.doesNotMatch(mainJs, /core\/router\.js\?v=/);
});
