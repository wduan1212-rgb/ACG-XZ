...
import { pruneEmptySessions } from "./agent/orchestrator.js?v=20260723-v117-2";
...
import { applyKeyOverrides, enableServerProxyIfConfigured } from "./api/llm.js?v=20260723-v117-2";
import { refreshProviderStatus } from "./api/providers.js";
import { resumeJobs } from "./api/jobs.js";
import { resumeActiveBatches } from "./agent/orchestrator.js?v=20260723-v117-2";
...
import { installSelectEnhancer } from "./ui/selectEnhancer.js?v=20260723-v117-2";
import { initLoginBeams } from "./ui/loginBeams.js";
import { installUIEnhancements } from "./ui/uiEnhancements.js";
import { overviewView } from "./views/overview.js?v=20260723-v117-2";
import { voiceLabView } from "./views/voiceLab.js?v=20260723-v117-2";
import { customCreationView } from "./views/customCreation.js?v=20260723-v117-2";
import { agentView } from "./agent/view.js?v=20260723-v117-2";
import { studioView } from "./views/studio.js?v=20260723-v117-2";
import { assetsView } from "./views/assetsView.js?v=20260723-v117-2";
import { deliveryView } from "./views/deliveryView.js?v=20260723-v117-2";
import { analyticsView } from "./views/analyticsView.js?v=20260723-v117-2";
import { draftsView } from "./views/draftsView.js";
import { settingsView } from "./views/settings.js?v=20260723-v117-2";
import "./views/accountDialog.js";
import { stagePage, openProductionDrawer } from "./views/prodDrawer.js?v=20260723-v117-2";
import { productionsOf } from "./domain/productions.js";

const APP_BUILD_ID = "20260723-v117-2";
