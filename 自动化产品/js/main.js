...
import { pruneEmptySessions, newSession, renameSession, deleteSession } from "./agent/orchestrator.js?v=20260810-v141-dashboard-metrics-1";
...
import { deliveredAssets, productTagLabel } from "./domain/delivery.js?v=20260810-v141-dashboard-metrics-1";
...
import { resumeActiveBatches } from "./agent/orchestrator.js?v=20260810-v141-dashboard-metrics-1";
import { registerView, initRouter, render, go, parseHash, allowStudioFromAgent } from "./core/router.js";
import { toast, confirmModal, promptModal, openModal, openPalette, toggleNotifyPanel, updateNotifyBadge } from "./ui/components.js?v=20260810-v141-dashboard-metrics-1";
import { installSelectEnhancer } from "./ui/selectEnhancer.js?v=20260723-v117-8";
import { initLoginBeams } from "./ui/loginBeams.js?v=20260810-v141-dashboard-metrics-1";
...
import { overviewView } from "./views/overview.js?v=20260810-v141-dashboard-metrics-1";
import { homeView } from "./views/home.js?v=20260810-v141-dashboard-metrics-1";
import { subscriptionView } from "./views/subscription.js?v=20260810-v141-dashboard-metrics-1";
import { voiceLabView } from "./views/voiceLab.js?v=20260810-v141-dashboard-metrics-1";
import { customCreationView } from "./views/customCreation.js?v=20260810-v141-dashboard-metrics-1";
import { agentView, openAgentSession } from "./agent/view.js?v=20260810-v141-dashboard-metrics-1";
import { studioView } from "./views/studio.js?v=20260810-v141-dashboard-metrics-1";
import { assetsView } from "./views/assetsView.js?v=20260810-v141-dashboard-metrics-1";
import { deliveryView } from "./views/deliveryView.js?v=20260810-v141-dashboard-metrics-1";
import { analyticsView } from "./views/analyticsView.js?v=20260727-v118-7";
import { draftsView } from "./views/draftsView.js?v=20260810-v141-dashboard-metrics-1";
import { settingsView } from "./views/settings.js?v=20260810-v141-dashboard-metrics-1";
import "./views/accountDialog.js";
import { stagePage, openProductionDrawer } from "./views/prodDrawer.js?v=20260810-v141-dashboard-metrics-1";
import { productionsOf } from "./domain/productions.js?v=20260810-v141-dashboard-metrics-1";

const APP_BUILD_ID = "20260810-v141-dashboard-metrics-1";
