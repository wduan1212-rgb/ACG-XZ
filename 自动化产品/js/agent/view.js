...
} from "./orchestrator.js?v=20260720-v104-1";
import { renderMessage, boardRow } from "./cards.js?v=20260720-v104-1";
import { openProductionDrawer } from "../views/prodDrawer.js?v=20260720-v104-1";
...
async function routeFilesToProduction(p, files) {
  ...
  const { maybeAdvanceAfterInput } = await import("./orchestrator.js?v=20260720-v104-1");
