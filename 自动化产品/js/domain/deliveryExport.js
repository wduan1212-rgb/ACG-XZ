...
function workbookEntries(rows, { start, end, generatedAt }) {
  ...
  return [
    ...
    ["docProps/app.xml", `${XML_HEADER}<Properties xmlns="http://schemas.openxmlformats.org/officeDocument/2006/extended-properties" xmlns:vt="http://schemas.openxmlformats.org/officeDocument/2006/docPropsVTypes"><Application>ACG-XZ</Application><DocSecurity>0</DocSecurity><ScaleCrop>false</ScaleCrop><AppVersion>143.3</AppVersion></Properties>`],
