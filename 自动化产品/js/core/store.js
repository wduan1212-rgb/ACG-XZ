...
import { mergeProductCatalog, PRODUCT_CATALOG_VERSION } from "../data/productCatalogSeed.js?v=20260813-v1432-publish-export-1";
import { normalizeLegacyInputFallbackState } from "../domain/productionFailureState.js?v=20260813-v1432-publish-export-1";
