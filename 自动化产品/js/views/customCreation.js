...
import { toast } from "../ui/components.js?v=20260804-v140-delivery-media-publish-1";
import { voiceLabView } from "./voiceLab.js?v=20260804-v140-delivery-media-publish-1";
...
export const customCreationView = {
  render(root, { page, resourceId } = {}) {
    ...
    const openPublishFor = async (key, payload = null) => {
      ...
      const { openCustomPublish } = await import("./customPublish.js?v=20260804-v140-delivery-media-publish-1");
    ...
    const mountTool = async key => {
      ...
      try {
        const module = key === "video"
          ? await import("./customVideoIntegration.js?v=20260804-v140-delivery-media-publish-1")
          : await import("./customCanvasIntegration.js?v=20260804-v140-delivery-media-publish-1");
