...
import { toast } from "../ui/components.js?v=20260817-v1436-token-plan-knowledge-2";
...
export const customCreationView = {
  render(root, { page, resourceId } = {}) {
    ...
    const openPublishFor = async (key, payload = null) => {
      ...
      const { openCustomPublish } = await import("./customPublish.js?v=20260817-v1436-token-plan-knowledge-2");
    ...
    const mountTool = async key => {
      ...
      try {
        const module = key === "video"
          ? await import("./customVideoIntegration.js?v=20260817-v1436-token-plan-knowledge-2")
          : await import("./customCanvasIntegration.js?v=20260817-v1436-token-plan-knowledge-2");
