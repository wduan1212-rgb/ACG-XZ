...
import { toast } from "../ui/components.js?v=20260815-v1435-ai-topic-partial-1";
...
export const customCreationView = {
  render(root, { page, resourceId } = {}) {
    ...
    const openPublishFor = async (key, payload = null) => {
      ...
      const { openCustomPublish } = await import("./customPublish.js?v=20260815-v1435-ai-topic-partial-1");
    ...
    const mountTool = async key => {
      ...
      try {
        const module = key === "video"
          ? await import("./customVideoIntegration.js?v=20260815-v1435-ai-topic-partial-1")
          : await import("./customCanvasIntegration.js?v=20260815-v1435-ai-topic-partial-1");
