...
import { voiceLabView } from "./voiceLab.js?v=20260728-v120-shell-12";
...
export const customCreationView = {
  render(root, { page, resourceId } = {}) {
    ...
    const openPublishFor = async (key, payload = null) => {
      ...
      const { openCustomPublish } = await import("./customPublish.js?v=20260728-v120-shell-12");
      openCustomPublish(
    ...
    const mountTool = async key => {
      ...
      try {
        const module = key === "video"
          ? await import("./customVideoIntegration.js?v=20260728-v120-shell-12")
          : await import("./customCanvasIntegration.js?v=20260728-v120-shell-12");
