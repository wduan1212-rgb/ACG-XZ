...
import { voiceLabView } from "./voiceLab.js?v=20260720-v103-4";
...
export const customCreationView = {
  render(root, { page } = {}) {
    ...
    const openPublishFor = async (key, payload = null) => {
      ...
      const { openCustomPublish } = await import("./customPublish.js?v=20260720-v103-4");
      openCustomPublish(
    ...
    const mountTool = async key => {
      ...
      try {
        const module = key === "video"
          ? await import("./customVideoIntegration.js?v=20260720-v103-4")
          : await import("./customCanvasIntegration.js?v=20260720-v103-4");
