...
import { voiceLabView } from "./voiceLab.js?v=20260717-v91-2";
...
export const customCreationView = {
  render(root, { page } = {}) {
    ...
    const openPublishFor = async (key, payload = null) => {
      ...
      const { openCustomPublish } = await import("./customPublish.js?v=20260717-v91-2");
      openCustomPublish(
    ...
    const mountTool = async key => {
      ...
      try {
        const module = key === "video"
          ? await import("./customVideoIntegration.js?v=20260717-v91-2")
          : await import("./customCanvasIntegration.js?v=20260717-v91-2");
