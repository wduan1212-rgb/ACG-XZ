...
import { emptyState, promptModal, confirmModal, openLightbox, openModal, toast, withLoading, removeWithMotion } from "../ui/components.js?v=20260809-v140-core-connectivity-2";
import { renderSupplierAccounts } from "./supplierViews.js?v=20260809-v140-core-connectivity-2";
  ...
  render(root) {
    ...
    const draw = () => {
      ...
      if (libraryMode === "drafts") {
        ...
        mountTopDock();
        wireLibraryTabs();
        import("./draftsView.js?v=20260809-v140-core-connectivity-2").then(({ draftsView }) => {
