...
import { emptyState, promptModal, confirmModal, openLightbox, openModal, toast, withLoading, removeWithMotion } from "../ui/components.js?v=20260806-v140-platform-stability-5";
import { renderSupplierAccounts } from "./supplierViews.js?v=20260806-v140-platform-stability-5";
  ...
  render(root) {
    ...
    const draw = () => {
      ...
      if (libraryMode === "drafts") {
        ...
        mountTopDock();
        wireLibraryTabs();
        import("./draftsView.js?v=20260806-v140-platform-stability-5").then(({ draftsView }) => {
