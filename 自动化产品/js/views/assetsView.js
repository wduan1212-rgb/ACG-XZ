...
import { emptyState, promptModal, confirmModal, openLightbox, openModal, toast, withLoading, removeWithMotion } from "../ui/components.js?v=20260804-v140-supplier-metric-sync-1";
import { renderSupplierAccounts } from "./supplierViews.js?v=20260804-v140-supplier-metric-sync-1";
  ...
  render(root) {
    ...
    const draw = () => {
      ...
      if (libraryMode === "drafts") {
        ...
        mountTopDock();
        wireLibraryTabs();
        import("./draftsView.js?v=20260804-v140-supplier-metric-sync-1").then(({ draftsView }) => {
