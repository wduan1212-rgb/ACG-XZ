...
import { emptyState, promptModal, confirmModal, openLightbox, openModal, toast, withLoading, removeWithMotion } from "../ui/components.js?v=20260808-v140-platform-stability-15";
import { renderSupplierAccounts } from "./supplierViews.js?v=20260808-v140-platform-stability-15";
  ...
  render(root) {
    ...
    const draw = () => {
      ...
      if (libraryMode === "drafts") {
        ...
        mountTopDock();
        wireLibraryTabs();
        import("./draftsView.js?v=20260808-v140-platform-stability-15").then(({ draftsView }) => {
