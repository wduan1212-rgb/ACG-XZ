...
import { emptyState, promptModal, confirmModal, openLightbox, openModal, toast, withLoading, removeWithMotion } from "../ui/components.js?v=20260805-v140-platform-stability-3";
import { renderSupplierAccounts } from "./supplierViews.js?v=20260805-v140-platform-stability-3";
  ...
  render(root) {
    ...
    const draw = () => {
      ...
      if (libraryMode === "drafts") {
        ...
        mountTopDock();
        wireLibraryTabs();
        import("./draftsView.js?v=20260805-v140-platform-stability-3").then(({ draftsView }) => {
