...
import { downloadAsset } from "../domain/delivery.js?v=20260814-v1433-batch-partial-recovery-1";
import { platChip, groupOf, isAvatarAsset } from "../domain/accounts.js";
import { emptyState, promptModal, confirmModal, openLightbox, openModal, toast, withLoading, removeWithMotion } from "../ui/components.js?v=20260814-v1433-batch-partial-recovery-1";
import { renderSupplierAccounts } from "./supplierViews.js?v=20260814-v1433-batch-partial-recovery-1";
  ...
  render(root) {
    ...
    const draw = () => {
      ...
      if (libraryMode === "drafts") {
        ...
        mountTopDock();
        wireLibraryTabs();
        import("./draftsView.js?v=20260814-v1433-batch-partial-recovery-1").then(({ draftsView }) => {
