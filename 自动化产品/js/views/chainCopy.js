...
import { toast, openLightbox, publishModal } from "../ui/components.js?v=20260804-v140-workshop-scroll-1";
import { go } from "../core/router.js";
import { stepperHtml, wireStepper } from "./studio.js?v=20260804-v140-workshop-scroll-1";
import { reviewPreviewHtml } from "./prodDrawer.js?v=20260804-v140-workshop-scroll-1";
...
export function renderReviewPage(root, p) {
  ...
  if (!isImg && !p.artifacts?.boards?.cover?.assetId) {
    ...
    const run = async () => {
      try {
        const { ensureVideoCover } = await import("./chainWorkshop.js?v=20260804-v140-workshop-scroll-1");
