...
import { stepperHtml, wireStepper } from "./studio.js?v=20260723-v117-1";
import { reviewPreviewHtml } from "./prodDrawer.js?v=20260723-v117-1";
...
export function renderReviewPage(root, p) {
  ...
  if (!isImg && !p.artifacts?.boards?.cover?.assetId) {
    ...
    const run = async () => {
      try {
        const { ensureVideoCover } = await import("./chainWorkshop.js?v=20260723-v117-1");
