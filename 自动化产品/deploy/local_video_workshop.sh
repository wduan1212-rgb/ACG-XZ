...
prepare_local_video_workshop() {
  ...
  export VIDEO_WORKSHOP_PROJECTS_DIR="${VIDEO_WORKSHOP_PROJECTS_DIR:-$APP_DIR/runtime/video-workshop/projects}"
  export VIDEO_WORKSHOP_OUTPUT_DIR="${VIDEO_WORKSHOP_OUTPUT_DIR:-$APP_DIR/runtime/video-workshop/outputs}"
  export VIDEO_WORKSHOP_UPLOAD_DIR="${VIDEO_WORKSHOP_UPLOAD_DIR:-$APP_DIR/runtime/video-workshop/uploads}"
