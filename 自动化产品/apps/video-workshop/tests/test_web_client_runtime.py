...
"""
    ...
    def test_all_client_ids_use_fallback_helper_and_event_paths_report_errors(self):
        ...
        self.assertIn("app.js?v=20260804-v140-usage-settlement-1", index)
        self.assertIn("styles.css?v=20260804-v140-usage-settlement-1", index)
        self.assertIn(
            'VIDEO_WORKSHOP_BUILD_ID = "20260804-v140-usage-settlement-1"',
